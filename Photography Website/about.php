...
<head>
   <title>Photography Website | About Us Page</title>
   ...
   <section class="about py-lg-4 py-md-3 py-sm-3 py-3">
      <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
         ...
         <div class="about-sub-inner text-center mt-lg-4 mt-3">
            <h4>Photography is Life
            </h4>
            <div class="row">
               <div class="col-lg-4 col-md-4 abut-gride">
                  <span class="fas fa-image"></span>
                  <h5>Crop</h5>
                  <p class="mt-3"> Crop or cropping refers to cutting away unwanted
                     areas of a photograph or changing its aspect ratio.
                  </p>
               </div>
               <div class="col-lg-4 col-md-4 abut-gride">
                  <span class="fas  fa-camera-retro fa-fade"></span>
                  <h5>Focus Selection Points </h5>
                  <p class="mt-3"> Leaving your camera on its default
                     settings will produce blurry results
                  </p>
               </div>
               <div class="col-lg-4 col-md-4 abut-gride">
                  <span class="fas fa-camera"></span>
                  <h5> Shutter Speed</h5>
                  <p class="mt-3"> Post processing won't fix a
                     blurry image from a slow shutter
                  </p>
               </div>
            </div>
         </div>
